...
export class AggiungiProdottoDialogComponent {
  prodottoForm: FormGroup;

  constructor(
    private fb: FormBuilder,
    private dialogRef: MatDialogRef<AggiungiProdottoDialogComponent>,
    ...
    this.prodottoForm = this.fb.group({
      ...
      prezzoUnitario: [0, [Validators.required, Validators.min(0.01)]]
    });
  }

  onSubmit(): void {
    if (this.prodottoForm.valid) {
      const nuovoProdotto: Inventario = {
      ...
      this.dialogRef.close(nuovoProdotto);
    }
  }
